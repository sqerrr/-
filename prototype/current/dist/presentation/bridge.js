    ...
    consume(events, time, snapshot) {
        ...
        for (const e of events) {
            if (e.type === 'SkillActivated')
                cues.push({ type: 'skillCast', time, skill: e.skill, x: e.x, z: e.z, aimX: e.aimX, aimZ: e.aimZ });
            else if (e.type === 'CombatShape')
                cues.push({ type: 'combatShape', time, source: e.source, shape: e.shape, intent: e.intent });
            else if (e.type === 'CatalystTriggered')
                cues.push({ type: 'catalyst', time, catalyst: e.catalyst, fromSlot: e.fromSlot, toSlot: e.toSlot, sourceX: e.sourceX, sourceZ: e.sourceZ, targetX: e.targetX, targetZ: e.targetZ });
                ...
                cues.push({ type: 'reaction', time, reaction: e.reaction, x: e.x, z: e.z, amount: e.amount });
