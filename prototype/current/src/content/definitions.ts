  ...
  cleaver: {
    ...
    mutations: [
      ...
      },
      {
        ...
        tag: 'зачистка',
        description:
          'Секач превращает фронтальный удар в полный круговой взмах без потери силы.'
      },
      {
        id: 'cleaver_hook',
        name: 'Крюк',
    ...
    mutations: [
      {
        ...
        tag: 'зачистка',
        description:
          'Каждый залп распадается на несколько полноценных зон и лучше зачищает толпу.'
      },
      {
        id: 'mortar_fuse',
        name: 'Длинный фитиль',
...
export const catalysts: Record<CatalystId, CatalystDef> = {
  source: {
    ...
    name: 'Финиш',
    shortName: 'В КОНЦЕ',
    desc: 'Когда левый феномен заканчивает путь или удар, правый срабатывает в этой точке.',
    color: '#74e4ff',
    scope: 'конец пути'
  },
  carrier: {
    id: 'carrier',
    name: 'Контакт',
    shortName: 'ПРИ КАСАНИИ',
    desc: 'Когда объект левого феномена касается цели или срабатывает в мире, правый запускается там же.',
    color: '#d7a0ff',
    scope: 'контакт'
  },
  trail: {
    ...
    name: 'След',
    shortName: 'ПО ПУТИ',
    desc: 'Правый феномен появляется вдоль уже пройденного пути левого.',
    color: '#8ff0b0',
    scope: 'траектория'
  },
  reverse: {
    ...
    name: 'Обратный ход',
    shortName: 'НАЗАД',
    desc: 'Когда левый феномен доходит до конца пути, правый идёт обратно по той же траектории.',
    color: '#ffb06a',
    scope: 'обратный путь'
  },
  collapse: {
    ...
    name: 'Схлопывание',
    shortName: 'К ЦЕНТРУ',
    desc: 'Правый феномен повторяет область левого и сжимается к её центру.',
    color: '#ff7ec8',
    scope: 'область'
  },
  capacitor: {
    ...
    shortName: '×ЦЕЛИ',
    desc: 'Чем больше целей задел левый феномен, тем больше раз срабатывает правый.',
    color: '#70d8ff',
  ...
  anchor: {
    ...
    name: 'Маршрутизатор',
    shortName: 'ЦЕНТР',
    desc: 'Правый феномен целится в центр группы, которую только что задел левый.',
    color: '#8ce5c7',
    scope: 'перенаведение'
  },
  reservoir: {
    id: 'reservoir',
    name: 'Напор массы',
    shortName: 'ТОЛПА→БОЛЬШЕ',
    desc: 'Если левый феномен задел большую группу, правый срабатывает несколько дополнительных раз.',
    color: '#79e19b',
  ...
  echo_shard: {
    ...
    name: 'Эхо-отпечаток',
    shortName: 'ЭХО',
    desc: 'Правый феномен один раз повторяется в точке, где только что сработал левый.',
    color: '#86d8ff',
    scope: 'отпечаток'
  },
  relay: {
  ...
  conduit: {
    ...
    name: 'Сплав',
    shortName: 'СВОЙСТВО',
    desc: 'Правый феномен переносит на свои цели совместимый эффект левого.',
    color: '#7ee7d2',
    scope: 'слияние'
  },
  overflow: {
    ...
    name: 'Возврат',
    shortName: '↩',
    desc: 'Если левый феномен задел большую группу, после правого левый срабатывает ещё раз.',
    color: '#ffb879',
    scope: 'петля'
  },
  aegis_relay: {
    ...
    name: 'Эгида потока',
    shortName: 'ЩИТ',
    desc: 'Чем больше врагов левый феномен сдвинул или остановил, тем больше барьера даёт следующий такт.',
    color: '#72cfff',
    scope: 'преобразование'
  },
  backflow: {
    ...
    name: 'Обратная связь',
    shortName: '↶',
    desc: 'Если правый феномен попал, следующий левый срабатывает ещё один раз.',
    color: '#b7a0ff',
  ...
  focus: {
    ...
    name: 'Сосредоточение',
    shortName: 'СОС',
    desc: 'На одно срабатывание меньше, зато оставшиеся заметно сильнее.',
    color: '#ffd36b',
    scope: 'концентрация'
  },
  surge: {
  ...
  glut: {
    ...
    name: 'Пресыщение',
    shortName: 'ПРС',
    desc: 'Чем больше целей задел предыдущий такт, тем сильнее этот — до ограниченного предела.',
    color: '#ff6b9d',
    scope: 'последствие'
  },
  stagger: {
  ...
  vault: {
    ...
    name: 'Панцирь толпы',
    shortName: 'ТОЛПА→ЩИТ',
    desc: 'Чем больше врагов задел правый феномен, тем больше барьера он сразу даёт.',
    color: '#c8b6ff',
...
export const resonance: Record<ResonanceId, ResonanceDef> = {
  ...
  multiplicity: {
    ...
    shortName: 'КОЛ-ВО',
    description:
      'Подходящие феномены создают больше снарядов, волн, лезвий или призванных объектов.',
    color: '#cf94ff'
  },
  precision: {
    id: 'precision',
    ...
    shortName: 'КРИТ',
    description:
      'Повышает шанс критического удара у подходящих феноменов.',
    color: '#ff9fd0'
  },
  persistence: {
    id: 'persistence',
    ...
    shortName: 'ВРЕМЯ',
    description:
      'Поля, турели и другие длительные эффекты существуют дольше.',
    color: '#79e19b'
  },
  conductivity: {
    id: 'conductivity',
