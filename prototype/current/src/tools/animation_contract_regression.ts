...
sentry.resonance.multiplicity=2; sentry.doctrines.quantity=4; sentryHarness.setActivationCountBonus(2);
...
arc.doctrines.quantity=6; arc.resonance.multiplicity=0; arcHarness.setActivationCountBonus(2);
arc.events=[];
